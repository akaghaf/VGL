...
if __name__  == '__main__':
    ...
    print(FreebayesRefAlleleFreq[1])
    now = datetime.now()
    ...
    df = pd.DataFrame({'Chromosome Location': Allvariants,
                    ...
                    "Case Allele Frequency": FreebayesRefAlleleFreq, 
                    "Case Alt 1 Frequency":FreebayesAlt1Freq, 
                    "Case Alt 2 Frequency":FreebayesAlt2Freq, 
                    "GATK Reference Allele Frequency":GATKRefAlleleFreq, 
                    "GATK Alt 1 Freq":GATKAlt1Freq, 
                    "GATK Alt 2 Freq":GATKAlt2Freq,
                    "Samtools Reference Allele Frequency":SamtoolsRefAlleleFreq, 
                    "Samtools Alt 1 Freq":SamtoolsAlt1Freq, 
                    "Samtools Alt 2 Freq":SamtoolsAlt2Freq})
#start comment section   
    ...
    df = df[(df['Case Allele Frequency'] != "1.0")]
